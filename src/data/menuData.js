export const menuData = [
  {
    ...
    children: [
      { id: "item-1", name: "Espresso", price: "$3.50", description: "Rich, bold single-shot espresso.", image: "CoffeeImage1.jpeg", tags: ["hot", "classic"], isPopular: true},
      { id: "item-2", name: "Double Espresso", price: "$4.50", description: "Twice the intensity with two espresso shots.", image: "CoffeeImage2.jpeg", tags: ["hot", "classic"], isPopular: true },
      { id: "item-3", name: "Macchiato", price: "$4.00", description: "Espresso topped with a small dollop of foam.", image: "CoffeeImage3.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-4", name: "Cortado", price: "$4.25", description: "Equal parts espresso and warm milk.", image: "CoffeeImage4.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-5", name: "Cappuccino", price: "$4.50", description: "Smooth espresso with steamed milk and foam.", image: "CoffeeImage5.jpeg", tags: ["hot"], isPopular: true },
      { id: "item-6", name: "Flat White", price: "$4.75", description: "Velvety espresso with micro-foamed milk.", image: "CoffeeImage6.jpeg", tags: ["hot"], isPopular: true },
      { id: "item-7", name: "Café Latte", price: "$4.75", description: "Creamy espresso with steamed milk.", image: "CoffeeImage7.jpeg", tags: ["hot"], isPopular: true },
      { id: "item-8", name: "Mocha", price: "$5.25", description: "Chocolate infused espresso latte.", image: "CoffeeImage8.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-9", name: "Caramel Macchiato", price: "$5.25", description: "Velvety espresso with caramel drizzle.", image: "CoffeeImage9.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-10", name: "Affogato", price: "$5.75", description: "Espresso poured over vanilla ice cream.", image: "CoffeeImage10.jpeg", tags: ["hot", "dessert"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-11", name: "Americano", price: "$3.75", description: "Hot water blended with premium espresso.", image: "CoffeeImage11.jpeg", tags: ["hot"], isPopular: true },
      { id: "item-12", name: "Long Black", price: "$3.75", description: "Strong, bold espresso over hot water.", image: "CoffeeImage12.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-13", name: "Brewed Coffee", price: "$3.25", description: "Classic slow-brewed coffee.", image: "CoffeeImage13.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-14", name: "French Press", price: "$4.00", description: "Rich and full-bodied pressed coffee.", image: "CoffeeImage14.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-15", name: "Pour-Over Coffee", price: "$4.25", description: "Manually crafted clean-flavor brew.", image: "CoffeeImage15.jpeg", tags: ["hot"], isPopular: false },
      { id: "item-16", name: "Iced Coffee", price: "$3.85", description: "Chilled brewed coffee over ice.", image: "CoffeeImage16.jpeg", tags: ["cold"], isPopular: true },
      { id: "item-17", name: "Cold Brew", price: "$4.25", description: "Slow-steeped cold brew with deep flavor.", image: "CoffeeImage17.jpeg", tags: ["cold"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-18", name: "Vanilla Latte", price: "$5.00", description: "Creamy latte infused with vanilla.", image: "CoffeeImage18.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-19", name: "Caramel Latte", price: "$5.25", description: "Latte with buttery caramel syrup.", image: "CoffeeImage19.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-20", name: "Hazelnut Latte", price: "$5.25", description: "Smooth latte with hazelnut flavor.", image: "CoffeeImage20.jpeg", tags: ["hot", "nutty"], isPopular: false },
      { id: "item-21", name: "Honey Cinnamon Latte", price: "$5.50", description: "Sweet honey and warm cinnamon.", image: "CoffeeImage21.jpeg", tags: ["hot", "spiced"], isPopular: true },
      { id: "item-22", name: "Matcha Latte", price: "$5.50", description: "Smooth Japanese matcha with milk.", image: "CoffeeImage22.jpeg", tags: ["hot", "green"], isPopular: true },
      { id: "item-23", name: "Red Velvet Latte", price: "$5.75", description: "Velvety red cocoa latte.", image: "CoffeeImage23.jpeg", tags: ["hot", "sweet"], isPopular: false },
      { id: "item-24", name: "Rose Latte", price: "$5.75", description: "Floral rose-infused creamy latte.", image: "CoffeeImage24.jpeg", tags: ["hot", "floral"], isPopular: false },
      { id: "item-25", name: "Mocha Art Latte", price: "$5.85", description: "Mocha topped with art-style foam.", image: "CoffeeImage25.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-26", name: "Seasonal Latte Art Special", price: "$6.00", description: "Unique seasonal latte design.", image: "CoffeeImage26.jpeg", tags: ["hot", "seasonal"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-27", name: "Coconut Cloud Latte", price: "$5.75", description: "Creamy coconut-infused latte.", image: "CoffeeImage27.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-28", name: "Brown Sugar Cold Foam Latte", price: "$5.85", description: "Iced latte with brown sugar foam.", image: "CoffeeImage28.jpeg", tags: ["cold", "sweet"], isPopular: true },
      { id: "item-29", name: "Spiced Ginger Latte", price: "$5.50", description: "Warm latte with ginger spice.", image: "CoffeeImage29.jpeg", tags: ["hot", "spiced"], isPopular: false },
      { id: "item-30", name: "Honey Almond Milk Latte", price: "$5.75", description: "Honey-sweetened almond milk latte.", image: "CoffeeImage30.jpeg", tags: ["hot", "sweet"], isPopular: true },
      { id: "item-31", name: "Choco-Mint Chill", price: "$5.50", description: "Mint chocolate iced drink.", image: "CoffeeImage31.jpeg", tags: ["cold", "sweet"], isPopular: true },
      { id: "item-32", name: "Pumpkin Spice Latte", price: "$6.00", description: "Seasonal pumpkin spice blend.", image: "CoffeeImage32.jpeg", tags: ["hot", "seasonal"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-33", name: "Coffee Frappe", price: "$5.00", description: "Blended iced coffee delight.", image: "CoffeeImage35.jpeg", tags: ["cold"], isPopular: true },
      { id: "item-34", name: "Mocha Frappe", price: "$5.25", description: "Chocolate blended frappe.", image: "CoffeeImage36.jpeg", tags: ["cold", "sweet"], isPopular: true },
      { id: "item-35", name: "Caramel Frappe", price: "$5.25", description: "Creamy caramel blended drink.", image: "CoffeeImage37.jpeg", tags: ["cold", "sweet"], isPopular: true },
      { id: "item-36", name: "Vanilla Cream Frappe", price: "$5.00", description: "Smooth vanilla frappe.", image: "CoffeeImage38.jpeg", tags: ["cold", "sweet"], isPopular: false },
      { id: "item-37", name: "Oreo Cookies Frappe", price: "$5.50", description: "Blended Oreos with cream.", image: "CoffeeImage39.jpeg.", tags: ["cold", "sweet"], isPopular: true },
      { id: "item-38", name: "Chocolate Milkshake", price: "$4.85", description: "Classic chocolate shake.", image: "CoffeeImage40.jpeg", tags: ["cold", "sweet"], isPopular: false },
      { id: "item-39", name: "Fruit Smoothie Blend", price: "$5.00", description: "Mixed fruit blended smoothie.", image: "CoffeeImage41.jpeg", tags: ["cold", "healthy"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-40", name: "English Breakfast Tea", price: "$3.00", description: "Classic robust black tea.", image: "CoffeeImage42.jpeg", tags: ["hot"], isPopular: true },
      { id: "item-41", name: "Earl Grey", price: "$3.25", description: "Floral bergamot black tea.", image: "CoffeeImage43.jpeg", tags: ["hot", "floral"], isPopular: false },
      { id: "item-42", name: "Green Tea", price: "$3.00", description: "Light and calming green tea.", image: "CoffeeImage44.jpeg", tags: ["hot", "healthy"], isPopular: true },
      { id: "item-43", name: "Chamomile", price: "$3.00", description: "Relaxing floral herbal tea.", image: "CoffeeImage45.jpeg", tags: ["hot", "herbal"], isPopular: false },
      { id: "item-44", name: "Hibiscus Tea", price: "$3.25", description: "Tart red herbal infusion.", image: "CoffeeImage46.jpeg", tags: ["hot", "herbal"], isPopular: false },
      { id: "item-45", name: "Lemon Ginger Tea", price: "$3.25", description: "Warm lemon and spicy ginger.", image: "CoffeeImage47.jpeg", tags: ["hot", "spiced"], isPopular: true },
      { id: "item-46", name: "Chai Tea", price: "$3.50", description: "Spiced black tea blend.", image: "CoffeeImage48.jpeg", tags: ["hot", "spiced"], isPopular: true },
      { id: "item-47", name: "Iced Lemon Tea", price: "$3.50", description: "Chilled lemon-infused tea.", image: "CoffeeImage49.jpeg", tags: ["cold"], isPopular: true },
      { id: "item-48", name: "Milk Tea", price: "$3.75", description: "Black tea brewed with milk.", image: "CoffeeImage50.jpeg", tags: ["hot", "sweet"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-49", name: "Classic Avocado Toast", price: "$7.50", description: "Fresh avocado on toasted sourdough.", image: "CoffeeImage51.jpeg", tags: ["healthy", "brunch"], isPopular: true },
      { id: "item-50", name: "Honey Berry Toast", price: "$6.75", description: "Greek yogurt, honey & mixed berries.", image: "CoffeeImage52.jpeg", tags: ["sweet", "brunch"], isPopular: true },
      { id: "item-51", name: "Smoked Salmon Toast", price: "$8.50", description: "Salmon with cream cheese & herbs.", image: "CoffeeImage53.jpeg", tags: ["protein", "brunch"], isPopular: false },
      { id: "item-52", name: "Banana Cinnamon Crunch Toast", price: "$6.50", description: "Banana, honey & cinnamon.", image: "CoffeeImage54.jpeg", tags: ["sweet", "brunch"], isPopular: false },
      { id: "item-53", name: "Ricotta & Fig Toast", price: "$7.00", description: "Creamy ricotta with fresh figs.", image: "CoffeeImage55.jpeg", tags: ["sweet", "brunch"], isPopular: false },
      { id: "item-54", name: "Tomato Basil Bruschetta Toast", price: "$6.75", description: "Fresh tomato, basil & olive oil.", image: "CoffeeImage56.jpeg", tags: ["healthy", "brunch"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-55", name: "Classic Avocado Smash", price: "$7.50", description: "Mashed avocado with olive oil.", image: "CoffeeImage56.jpeg", tags: ["healthy"], isPopular: true },
      { id: "item-56", name: "Avo & Poached Egg Smash", price: "$8.75", description: "Avocado smash topped with poached egg.", image: "CoffeeImage57.jpeg", tags: ["protein", "healthy"], isPopular: true },
      { id: "item-57", name: "Chili Lime Avocado Smash", price: "$7.75", description: "Zesty lime and chili avocado mix.", image: "CoffeeImage58.jpeg", tags: ["spicy", "healthy"], isPopular: false },
      { id: "item-58", name: "Avo Feta Smash", price: "$8.25", description: "Crumbled feta on avo smash.", image: "CoffeeImage59.jpeg", tags: ["cheesy", "healthy"], isPopular: true }
    ]
  },

  {
    ...
    children: [
      { id: "item-59", name: "Red Velvet Cupcake", price: "$4.00", description: "Soft red velvet topped with cream cheese.", image: "CoffeeImage60.jpeg", tags: ["sweet"], isPopular: true },
      { id: "item-60", name: "Chocolate Fudge Cupcake", price: "$4.25", description: "Rich chocolate cupcake with fudge frosting.", image: "CoffeeImage61.jpeg", tags: ["sweet"], isPopular: true },
      { id: "item-61", name: "Vanilla Cream Cupcake", price: "$3.85", description: "Classic vanilla cupcake.", image: "CoffeeImage62.jpeg", tags: ["sweet"], isPopular: false },
      { id: "item-62", name: "Lemon Zest Cupcake", price: "$3.95", description: "Citrusy lemon cupcake.", image: "CoffeeImage63.jpeg", tags: ["sweet", "citrus"], isPopular: false },
      { id: "item-63", name: "Caramel Crunch Cupcake", price: "$4.25", description: "Caramel cupcake with crunchy topping.", image: "CoffeeImage64.jpeg", tags: ["sweet"], isPopular: true }
    ]
  },

  {
   ...
   children: [
  { id: "item-64", name: "Classic Butter Scone", price: "$3.50", description: "Buttery flaky scone.", image: "CoffeeImage65.jpeg"},
  { id: "item-65", name: "Blueberry Scone", price: "$4.00", description: "Soft crumb with fresh blueberries baked inside.", image: "CoffeeImage66.jpeg" },
  { id: "item-66", name: "Lemon Glazed Scone", price: "$4.20", description: "Bright citrusy flavor topped with a zesty lemon glaze.", image: "CoffeeImage67.jpeg" },
  { id: "item-67", name: "Chocolate Chip Scone", price: "$4.50", description: "Golden scone filled with rich chocolate chips.", image: "CoffeeImage68.jpeg" },
  { id: "item-68", name: "Cranberry Orange Scone", price: "$4.25", description: "Sweet-tart cranberries paired with fresh orange zest.", image: "CoffeeImage69.jpeg" },
  { id: "item-69", name: "Maple Pecan Scone", price: "$4.75", description: "Warm maple flavor with crunchy toasted pecans.", image: "CoffeeImage70.jpeg" },
  { id: "item-70", name: "Raspberry White Chocolate Scone", price: "$5.00", description: "Sweet raspberries blended with creamy white chocolate chunks.", image: "CoffeeImage71.jpeg" }
]
  }
];
