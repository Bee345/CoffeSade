...
export const placeOrder = createAsyncThunk(
  ...
  async (_, { getState, rejectWithValue }) => {
    ...
    const { items, total } = cart; // Pull from cart state
    ...
    const newOrder = {
      ...
      status: "pending",
      loyaltySaved: total * 0.1, // Example: 10% loyalty savings
...
export const { removeOrder, clearOrders, setOrders } = orderSlice.actions;
