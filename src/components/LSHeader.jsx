...
const Header = () => {
  ...
  return (
    <>
      <header className="w-full fixed h-[80px] sm:h-[90px] flex justify-center top-0 items-center gap-4 sm:gap-8 lg:gap-90 bg-[#455238] shadow-lg z-50 px-10 sm:px-10 lg:px-0">
        {/* Logo Container */}
        ...
        {/* Desktop Nav */}
        <nav className="hidden lg:flex justify-center items-center gap-5 py-3 px-5 font-inter text-sm lg:text-base text-[#ede6df] flex-1 max-w-6xl">
