...
const ReviewsBanner = () => {
  ...
  <div className="leftSide w-full lg:w-1/2 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 order-2 lg:order-1">
    <h2 className="w-full lg:w-fit lg:max-w-[350px] text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[60px] text-[#ede6df] leading-tight sm:leading-snug lg:leading-[1.2] font-playfair font-bold mb-2 sm:mb-4 lg:mb-6">A Sip of Pure Comfort</h2>
    <p className="w-full lg:w-[60%] lg:min-w-[410px] text-[#ede6df] mt-3 sm:mt-4 lg:mt-5 mb-4 sm:mb-5 lg:mb-6 font-inter text-xs sm:text-sm md:text-base lg:text-[14px]">Wrap your hands around a warm mug and let the world slow down. Our blends are designed to soothe, uplift, and inspire your day.</p>
  ...
  <div className="rightSide w-full lg:w-1/2 text-xs sm:text-sm h-fit rounded-2xl lg:rounded-3xl my-4 sm:my-6 lg:my-8 xl:my-10 shadow-md lg:shadow-lg order-1 lg:order-2">
    <img src="CoffeeBanner3.jpeg" alt="Banner Image" className="rounded-2xl lg:rounded-3xl w-full h-auto object-cover"/>
  </div>
</section>
    </>
  )
